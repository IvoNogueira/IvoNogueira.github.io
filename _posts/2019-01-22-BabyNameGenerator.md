...
date: 2019-01-22
tags: [data science, NLP, RNN]
header:
  image: "/images/babynames/baby_name_small.png"
excerpt: "Data Science, NLP, RNN"
---
...
<h1 id="Baby-Name-Generator">Baby Name Generator<a class="anchor-link" href="#Baby-Name-Generator">&#182;</a></h1><p>Are you the parent of a new born? Do you fear a life of regret ancored in a single moment of extasy that you would gladly trade for your a chance at your recently lost freedom and hope? Well, too bad, there is no remedy for that. But I can help you come up with a name for your baby.</p>
<p>In this project we are going to create an RNN that understands the basics of Portuguese names and can output some belivable names. They will not be perfect but, then again, you do not love this baby. This exercise is inspired in the coding challenge of the last course of the deep learning specialization by deeplearning.ai hosted on coursera.</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="1---Problem-Statement">1 - Problem Statement<a class="anchor-link" href="#1---Problem-Statement">&#182;</a></h2><h3 id="1.1---Dataset-and-Preprocessing">1.1 - Dataset and Preprocessing<a class="anchor-link" href="#1.1---Dataset-and-Preprocessing">&#182;</a></h3><p>We start by loading this <a href="https://github.com/hadley/data-baby-names/blob/master/baby-names.csv">dataset</a> cointaining a list of baby names, and then creating a list of unique characters (such as a-z).</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">data</span> <span class="o">=</span> <span class="nb">open</span><span class="p">(</span><span class="s1">&#39;baby.txt&#39;</span><span class="p">,</span> <span class="s1">&#39;r&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">read</span><span class="p">()</span>
<span class="c1">#data = pd.read_csv(&#39;baby-names.csv&#39;)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">char_to_ix</span> <span class="o">=</span> <span class="p">{</span> <span class="n">ch</span><span class="p">:</span><span class="n">i</span> <span class="k">for</span> <span class="n">i</span><span class="p">,</span><span class="n">ch</span> <span class="ow">in</span> <span class="nb">enumerate</span><span class="p">(</span><span class="nb">sorted</span><span class="p">(</span><span class="n">chars</span><span class="p">))</span> <span class="p">}</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="1.2---Overview-of-the-model">1.2 - Overview of the model<a class="anchor-link" href="#1.2---Overview-of-the-model">&#182;</a></h3><p>The end model will have the following structure:</p>
<ul>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="2---Building-blocks-of-the-model">2 - Building blocks of the model<a class="anchor-link" href="#2---Building-blocks-of-the-model">&#182;</a></h2>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">def</span> <span class="nf">clip</span><span class="p">(</span><span class="n">gradients</span><span class="p">,</span> <span class="n">maxValue</span><span class="p">):</span>
    <span class="sd">&#39;&#39;&#39;</span>
...
$$ a^{\langle t+1 \rangle} = \tanh(W_{ax}  x^{\langle t+1 \rangle } + W_{aa} a^{\langle t \rangle } + b)\tag{1}$$$$ z^{\langle t + 1 \rangle } = W_{ya}  a^{\langle t + 1 \rangle } + b_y \tag{2}$$$$ \hat{y}^{\langle t+1 \rangle } = softmax(z^{\langle t + 1 \rangle })\tag{3}$$<p>Note that $\hat{y}^{\langle t+1 \rangle }$ is a (softmax) probability vector (its entries are between 0 and 1 and sum to 1). $\hat{y}^{\langle t+1 \rangle}_i$ represents the probability that the character indexed by "i" is the next character.</p>
<ul>
<li><strong>Step 3</strong>: Carry out sampling: Pick the next character's index according to the probability distribution specified by $\hat{y}^{\langle t+1 \rangle }$. This means that if $\hat{y}^{\langle t+1 \rangle }_i = 0.16$, we will pick the index "i" with 16% probability. </li>
</ul>
<p>This means that we will pick the <code>index</code> according to the distribution:
$P(index = 0) = 0.1, P(index = 1) = 0.0, P(index = 2) = 0.7, P(index = 3) = 0.2$.</p>
<ul>
<li><strong>Step 4</strong>: The last step to implement in <code>sample()</code> is to overwrite the variable <code>x</code>, which currently stores $x^{\langle t \rangle }$, with the value of $x^{\langle t + 1 \rangle }$. You will represent $x^{\langle t + 1 \rangle }$ by creating a one-hot vector corresponding to the character you've chosen as your prediction. You will then forward propagate $x^{\langle t + 1 \rangle }$ in Step 1 and keep repeating the process until you get a "\n" character, indicating you've reached the end of the baby name. </li>
</ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">def</span> <span class="nf">sample</span><span class="p">(</span><span class="n">parameters</span><span class="p">,</span> <span class="n">char_to_ix</span><span class="p">,</span> <span class="n">seed</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="c1"># Step 1: Create the one-hot vector x for the first character (initializing the sequence generation).</span>
    ...
    <span class="c1"># Idx is a flag to detect a newline character, we initialize it to -1</span>
    <span class="n">idx</span> <span class="o">=</span> <span class="o">-</span><span class="mi">1</span>

    <span class="c1"># Loop over time-steps t. At each time-step, sample a character from a probability distribution and append </span>
    <span class="c1"># its index to &quot;indices&quot;. We&#39;ll stop if we reach 50 characters (which should be very unlikely with a well </span>
    <span class="c1"># trained model), which helps debugging and prevents entering an infinite loop. </span>
    ...
    <span class="k">while</span> <span class="p">(</span><span class="n">idx</span> <span class="o">!=</span> <span class="n">newline_character</span> <span class="ow">and</span> <span class="n">counter</span> <span class="o">!=</span> <span class="mi">50</span><span class="p">):</span>
        ...
        <span class="c1"># Step 4: Overwrite the input character as the one corresponding to the sampled index.</span>
        <span class="n">x</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">zeros</span><span class="p">((</span><span class="n">vocab_size</span><span class="p">,</span> <span class="mi">1</span><span class="p">))</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="3---Building-the-language-model">3 - Building the language model<a class="anchor-link" href="#3---Building-the-language-model">&#182;</a></h2><p>It is time to build the character-level language model for text generation.</p>
<h3 id="3.1---Gradient-descent">3.1 - Gradient descent<a class="anchor-link" href="#3.1---Gradient-descent">&#182;</a></h3><p>In this section we will implement a function performing one step of stochastic gradient descent (with clipped gradients). We will go through the training examples one at a time, so the optimization algorithm will be stochastic gradient descent.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">def</span> <span class="nf">optimize</span><span class="p">(</span><span class="n">X</span><span class="p">,</span> <span class="n">Y</span><span class="p">,</span> <span class="n">a_prev</span><span class="p">,</span> <span class="n">parameters</span><span class="p">,</span> <span class="n">learning_rate</span> <span class="o">=</span> <span class="mf">0.01</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="n">gradients</span> <span class="o">=</span> <span class="n">clip</span><span class="p">(</span><span class="n">gradients</span><span class="p">,</span> <span class="n">maxValue</span><span class="o">=</span><span class="mi">5</span><span class="p">)</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="3.2---Training-the-model">3.2 - Training the model<a class="anchor-link" href="#3.2---Training-the-model">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Given the dataset of baby names, we use each line of the dataset (one name) as one training example. Every 100 steps of stochastic gradient descent, we will sample 10 randomly chosen names to see how the algorithm is doing.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">def</span> <span class="nf">model</span><span class="p">(</span><span class="n">data</span><span class="p">,</span> <span class="n">ix_to_char</span><span class="p">,</span> <span class="n">char_to_ix</span><span class="p">,</span> <span class="n">num_iterations</span> <span class="o">=</span> <span class="mi">35000</span><span class="p">,</span> <span class="n">n_a</span> <span class="o">=</span> <span class="mi">50</span><span class="p">,</span> <span class="n">baby_names</span> <span class="o">=</span> <span class="mi">7</span><span class="p">,</span> <span class="n">vocab_size</span> <span class="o">=</span> <span class="mi">27</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">    Trains the model and generates baby names. </span>
<span class="sd">    </span>
<span class="sd">    Arguments:</span>
<span class="sd">    data -- text corpus</span>
...
<span class="sd">    baby_names -- number of baby names you want to sample at each iteration. </span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="n">loss</span> <span class="o">=</span> <span class="n">get_initial_loss</span><span class="p">(</span><span class="n">vocab_size</span><span class="p">,</span> <span class="n">baby_names</span><span class="p">)</span>

    <span class="c1"># Build list of all baby names (training examples).</span>
    <span class="k">with</span> <span class="nb">open</span><span class="p">(</span><span class="s2">&quot;baby.txt&quot;</span><span class="p">)</span> <span class="k">as</span> <span class="n">f</span><span class="p">:</span>
    ...
    <span class="n">examples</span> <span class="o">=</span> <span class="p">[</span><span class="n">x</span><span class="o">.</span><span class="n">lower</span><span class="p">()</span><span class="o">.</span><span class="n">strip</span><span class="p">()</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">examples</span><span class="p">]</span>

    <span class="c1"># Shuffle list of all baby names</span>
    ...
    <span class="k">for</span> <span class="n">j</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">num_iterations</span><span class="p">):</span>
        ...
        <span class="n">index</span> <span class="o">=</span> <span class="n">j</span> <span class="o">%</span> <span class="nb">len</span><span class="p">(</span><span class="n">examples</span><span class="p">)</span>
        <span class="n">X</span> <span class="o">=</span> <span class="p">[</span><span class="kc">None</span><span class="p">]</span> <span class="o">+</span> <span class="p">[</span><span class="n">char_to_ix</span><span class="p">[</span><span class="n">ch</span><span class="p">]</span> <span class="k">for</span> <span class="n">ch</span> <span class="ow">in</span> <span class="n">examples</span><span class="p">[</span><span class="n">index</span><span class="p">]]</span>
        <span class="n">Y</span> <span class="o">=</span> <span class="n">X</span><span class="p">[</span><span class="mi">1</span><span class="p">:]</span> <span class="o">+</span> <span class="p">[</span><span class="n">char_to_ix</span><span class="p">[</span><span class="s2">&quot;</span><span class="se">\n</span><span class="s2">&quot;</span><span class="p">]]</span>
        ...
        <span class="c1"># Use a latency trick to keep the loss smooth. It happens here to accelerate the training.</span>
        ...
        <span class="k">if</span> <span class="n">j</span> <span class="o">%</span> <span class="mi">2000</span> <span class="o">==</span> <span class="mi">0</span><span class="p">:</span>
            ...
            <span class="c1"># The number of baby names to print</span>
            <span class="n">seed</span> <span class="o">=</span> <span class="mi">0</span>
            <span class="k">for</span> <span class="n">name</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">baby_names</span><span class="p">):</span>
                ...
                <span class="n">print_sample</span><span class="p">(</span><span class="n">sampled_indices</span><span class="p">,</span> <span class="n">ix_to_char</span><span class="p">)</span>

                <span class="n">seed</span> <span class="o">+=</span> <span class="mi">1</span>  <span class="c1"># To get the same result for grading purposed, increment the seed by one. </span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Putting it all together it is now time to run the model!</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">parameters</span> <span class="o">=</span> <span class="n">model</span><span class="p">(</span><span class="n">data</span><span class="p">,</span> <span class="n">ix_to_char</span><span class="p">,</span> <span class="n">char_to_ix</span><span class="p">)</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Iteration: 0, Loss: 23.070857
...
Iteration: 10000, Loss: 15.713216
...
Iteration: 12000, Loss: 15.400784
...
Iteration: 14000, Loss: 15.118299
...
Iteration: 16000, Loss: 15.041470
...
Iteration: 18000, Loss: 14.806558
...
Iteration: 20000, Loss: 14.799829
...
Iteration: 22000, Loss: 14.542274
...
Iteration: 24000, Loss: 14.622371
...
Iteration: 26000, Loss: 14.495922
...
Iteration: 28000, Loss: 14.385710
...
Iteration: 30000, Loss: 14.642537
...
Iteration: 32000, Loss: 14.337960
...
Iteration: 34000, Loss: 14.332529
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Conclusion">Conclusion<a class="anchor-link" href="#Conclusion">&#182;</a></h2><p>As we can see above, after a few thousand iterations, our model learnt to generate reasonable-looking names.
Now, to be fair, not all of the names are winners. But, as we can see, any of the final list of look like real names. In this particular example, we suggest the name <strong>Fuston</strong>. Feel free to play with the code provided and generate other names.</p>
...
<ul>
<li>deeplearning.ai exercise</li>
<li>Original inspiration from Andrej Karpathy's implementation: <a href="https://gist.github.com/karpathy/d4dee566867f8291f086">https://gist.github.com/karpathy/d4dee566867f8291f086</a>. To learn more about text generation, also check out Karpathy's <a href="http://karpathy.github.io/2015/05/21/rnn-effectiveness/">blog post</a>.</li>
</ul>
